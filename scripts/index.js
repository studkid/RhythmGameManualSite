...
/* harmony export */   B: () => (/* binding */ EventBasedManager),
/* harmony export */   BX: () => (/* binding */ MessageManager),
/* harmony export */   Ck: () => (/* binding */ Hint),
/* harmony export */   F8: () => (/* binding */ UnauthenticatedError),
/* harmony export */   FV: () => (/* binding */ TextualMessageNode),
/* harmony export */   I$: () => (/* binding */ targetVersion),
/* harmony export */   I8: () => (/* binding */ slotTypes),
/* harmony export */   Ik: () => (/* binding */ SocketError),
/* harmony export */   JL: () => (/* binding */ itemClassifications),
/* harmony export */   Kj: () => (/* binding */ Client),
/* harmony export */   P: () => (/* binding */ permissions),
/* harmony export */   Pz: () => (/* binding */ DataStorageManager),
/* harmony export */   Qd: () => (/* binding */ LoginError),
/* harmony export */   R3: () => (/* binding */ PlayerMessageNode),
/* harmony export */   Yy: () => (/* binding */ ItemsManager),
/* harmony export */   Zx: () => (/* binding */ BaseMessageNode),
/* harmony export */   ai: () => (/* binding */ Player),
/* harmony export */   bz: () => (/* binding */ itemsHandlingFlags),
/* harmony export */   c1: () => (/* binding */ ArgumentError),
/* harmony export */   cW: () => (/* binding */ PackageMetadata),
/* harmony export */   cf: () => (/* binding */ DeathLinkManager),
/* harmony export */   dr: () => (/* binding */ SocketManager),
/* harmony export */   iE: () => (/* binding */ clientStatuses),
/* harmony export */   iW: () => (/* binding */ PlayersManager),
/* harmony export */   jH: () => (/* binding */ IntermediateDataOperation),
/* harmony export */   m: () => (/* binding */ defaultConnectionOptions),
/* harmony export */   nC: () => (/* binding */ exports_api),
/* harmony export */   pK: () => (/* binding */ defaultClientOptions),
/* harmony export */   pT: () => (/* binding */ ColorMessageNode),
/* harmony export */   q1: () => (/* binding */ DataPackageManager),
/* harmony export */   q7: () => (/* binding */ Item),
/* harmony export */   qB: () => (/* binding */ RoomStateManager),
/* harmony export */   rX: () => (/* binding */ ItemMessageNode),
/* harmony export */   rr: () => (/* binding */ LocationMessageNode),
/* harmony export */   u4: () => (/* binding */ libraryVersion)
/* harmony export */ });
...
// src/constants.ts
var targetVersion = { major: 0, minor: 6, build: 3 };
  ...
  async fetchPackage(games = [], update = true) {
    ...
    if (this.#cache) {
      ...
      for (const game of games) {
        ...
        if (cachedPackage) {
          data2.games[game] = cachedPackage;
        } else {
          notFoundGames.push(game);
        }
      }
      if (update) {
        this.importPackage(data2);
      }
      games = notFoundGames;
    }
    const data = { games: {} };
...
var __webpack_exports__ArgumentError = __webpack_exports__.c1;
var __webpack_exports__BaseMessageNode = __webpack_exports__.Zx;
var __webpack_exports__Client = __webpack_exports__.Kj;
var __webpack_exports__ColorMessageNode = __webpack_exports__.pT;
var __webpack_exports__DataPackageManager = __webpack_exports__.q1;
var __webpack_exports__DataStorageManager = __webpack_exports__.Pz;
var __webpack_exports__DeathLinkManager = __webpack_exports__.cf;
var __webpack_exports__EventBasedManager = __webpack_exports__.B;
var __webpack_exports__Hint = __webpack_exports__.Ck;
var __webpack_exports__IntermediateDataOperation = __webpack_exports__.jH;
var __webpack_exports__Item = __webpack_exports__.q7;
var __webpack_exports__ItemMessageNode = __webpack_exports__.rX;
var __webpack_exports__ItemsManager = __webpack_exports__.Yy;
var __webpack_exports__LocationMessageNode = __webpack_exports__.rr;
var __webpack_exports__LoginError = __webpack_exports__.Qd;
var __webpack_exports__MessageManager = __webpack_exports__.BX;
var __webpack_exports__PackageMetadata = __webpack_exports__.cW;
var __webpack_exports__Player = __webpack_exports__.ai;
var __webpack_exports__PlayerMessageNode = __webpack_exports__.R3;
var __webpack_exports__PlayersManager = __webpack_exports__.iW;
var __webpack_exports__RoomStateManager = __webpack_exports__.qB;
var __webpack_exports__SocketError = __webpack_exports__.Ik;
var __webpack_exports__SocketManager = __webpack_exports__.dr;
var __webpack_exports__TextualMessageNode = __webpack_exports__.FV;
var __webpack_exports__UnauthenticatedError = __webpack_exports__.F8;
var __webpack_exports__clientStatuses = __webpack_exports__.iE;
var __webpack_exports__defaultClientOptions = __webpack_exports__.pK;
var __webpack_exports__defaultConnectionOptions = __webpack_exports__.m;
var __webpack_exports__itemClassifications = __webpack_exports__.JL;
var __webpack_exports__itemsHandlingFlags = __webpack_exports__.bz;
var __webpack_exports__libraryVersion = __webpack_exports__.u4;
var __webpack_exports__permissions = __webpack_exports__.P;
var __webpack_exports__slotTypes = __webpack_exports__.I8;
var __webpack_exports__targetVersion = __webpack_exports__.I$;
export { __webpack_exports__API as API, __webpack_exports__ArgumentError as ArgumentError, __webpack_exports__BaseMessageNode as BaseMessageNode, __webpack_exports__Client as Client, __webpack_exports__ColorMessageNode as ColorMessageNode, __webpack_exports__DataPackageManager as DataPackageManager, __webpack_exports__DataStorageManager as DataStorageManager, __webpack_exports__DeathLinkManager as DeathLinkManager, __webpack_exports__EventBasedManager as EventBasedManager, __webpack_exports__Hint as Hint, __webpack_exports__IntermediateDataOperation as IntermediateDataOperation, __webpack_exports__Item as Item, __webpack_exports__ItemMessageNode as ItemMessageNode, __webpack_exports__ItemsManager as ItemsManager, __webpack_exports__LocationMessageNode as LocationMessageNode, __webpack_exports__LoginError as LoginError, __webpack_exports__MessageManager as MessageManager, __webpack_exports__PackageMetadata as PackageMetadata, __webpack_exports__Player as Player, __webpack_exports__PlayerMessageNode as PlayerMessageNode, __webpack_exports__PlayersManager as PlayersManager, __webpack_exports__RoomStateManager as RoomStateManager, __webpack_exports__SocketError as SocketError, __webpack_exports__SocketManager as SocketManager, __webpack_exports__TextualMessageNode as TextualMessageNode, __webpack_exports__UnauthenticatedError as UnauthenticatedError, __webpack_exports__clientStatuses as clientStatuses, __webpack_exports__defaultClientOptions as defaultClientOptions, __webpack_exports__defaultConnectionOptions as defaultConnectionOptions, __webpack_exports__itemClassifications as itemClassifications, __webpack_exports__itemsHandlingFlags as itemsHandlingFlags, __webpack_exports__libraryVersion as libraryVersion, __webpack_exports__permissions as permissions, __webpack_exports__slotTypes as slotTypes, __webpack_exports__targetVersion as targetVersion };
